    ...
    <div id="modal-gasto" class="modal-container">
      <div class="modal-metas">
        <div class="infoTran-metas">
          <h1 class="tituloTran-metas">Atualizar Metas</h1>
          <h2 id="tipoMetas">Metas</h2>
        </div>
        ...
        <form class="form" method="POST" action="../../src/controller/metas.update.controller.php">
          <div class="input-sup">
            <div class="input">
              ...
              <input type="text" id="name" name="value" class="metas" value="<?= $metas[0]["VALOR_META"] ?>">
            </div>
            <div class="input">
              <label for="text"><b>Data Final</b></label></b>
              <input type="date" id="data" name="data" class="metas" value="<?= $metas[0]["DATA_META"] ?>">
            </div>
            <div class="input">
              <label for="text"><b>Descrição</b></label></b>
              <textarea nid="description" name="description" class="metas" cols="30" rows="10" value="<?= $metas[0]["DESCRICAO_META"] ?>"><?= $metas[0]["DESCRICAO_META"] ?></textarea>
            </div>
