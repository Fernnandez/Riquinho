...
require "../controller/update.transacao.controller.php";
          ...
          <form class="form" method="POST" action="../controller/update.transacao.controller.php">
            <div class="input-sup">
              ...
              <div class="input">
                ...
                <input type="date" id="data" name="DATA_TRAN" value="<?= $receita[0]["DATA_TRAN"] ?>" class="receita">
              </div>
            </div>
            ...
            <div class='input-inf'>
              <div class="input">
                ...
                <input type="text" id="valor" name="valor" value="<?= $receita[0]["VALOR_TRAN"] ?>" class="receita">
              </div>
              <div class="input">
                <label for="info"><b>Info</b></label></b>
                <input type="text" id="info" name="info" value="<?= $receita[0]["INFO"] ?>" class="receita">
              </div>
              <div class="input" style="display: none;">
                <label for="info"><b>Info</b></label></b>
                <input type="text" id="info" name="ID" value="<?= $receita[0]["ID"] ?>" class="receita">
              </div>
